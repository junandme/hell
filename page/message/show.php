  ...
  <div class="container">
    <table class="table table-striped table-hover ">
      <thead>
        ...
        $sql = "SELECT * from send WHERE rec='{$_SESSION['login_id']}'ORDER BY num DESC LIMIT $start_record, $record_to_get";
        $result = mysqli_query($conn,$sql);
        ?>
        ...
        <tr class="info" >
          ...
          <td style='word-break:break-all; cursor:hand;' onclick="document.location = '/page/message/showtext.php?num=<?php echo $data['num']; ?>';"><a href="#"><?php echo $data['title'] ?></a></td>
    ...
    <div class="pull-right col-lg-6 col-lg-offset-3">
          <a href="/page/message/msg.php" class="btn btn-default">Write</a>
        </div>
  <!-- 페이지번호 -->
    <div align="center">
      <ul class="pagination">
